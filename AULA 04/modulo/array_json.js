...
/*
    ...
    Array -> É um objeto na memória que permite trabalhar com vários valores em um único objeto. NÚMERO GRANDE DE DADOS DENTRO DE UMA VARIÁVEL  
    ...
    JSON -> É um objeto na memória que permite trabalhar com CHAVE e VALOR.         !!!!!       ATRIBUTOS       !!!!!!

                AO INVÉS DE CRIAR 3 VÁRIAVEIS
        let nome        = 'José'
        let telefone    = '123456789'
        let email       = 'jose@gmail.com'

                EU CRIO UMA E COLOCO OS ATRIBUTOS DENTRO DELA (JSON)
...
const exibirDados = function(){
    ...
    //Retorna o tipo de dados de um indice do array (typeofs)
    ...
    //     let cont = 0
    //     while(cont < listaDeNomes.length){ //length: é usada para determinar o tamanho ou a quantidade de elementos em uma estrutura. Ex: "Olá".length -> retorna 3.
    //         //[1, 2, 3].length -> retorna 3. Basicamente retorna toda a quantidade de elemntos dentro da estrutura
    //         console.log(`O nome do cliente é: ${listaDeNomes[cont]}`)
    //         cont+=1 //para não se repetir. Não virar um looping infinito
    //  }
    ...
    // FOR EACH - Retorna o conteúdo de cada elemento através de um CALL BACK: é uma função passada como argumento para outra função,
    //  que é executada após a conclusão de uma operação ou evento específico.
    // no js é uma função de call back
     console.log('********* FOR EACH *********') //não trabalha c/ contador (++, cont+=) ele mesmo atribui
    ...
    //     //console.log(cont) //para ver os indices
    //     console.log(`O nome do cliente é: ${listaDeNomes[cont]}`) //Colocamos dentro de um array [] para que eu obtivesse apenas os nomes sem o indice.
    // }     
    ...
    //                         PARA SABER A QUANTIDADE DE ELEMENTOS/ITENS EU TENHO NO ARRAY
                                            //console.log(listaDeNomes.length)  
                            //Ou seja, ele retorna o a quantidade exata de elementos//
...
const manipularDados = function(){
    //Adicionando valores novos dentro do array através de ÍNDICES. 
    //Apenas tenha cuidado em colocar no array um indice já existente, pois ele vai tirar o elemento desse indice e SUBSTITUIR,
    // pelo que está colocando.

    // listaDeClientes[0] = 'José da Silva'
    // listaDeClientes[1] = 'Maria da Silva'
    // listaDeClientes[2] = 'João da Silva'
    // listaDeClientes[3] = 'Alex da Silva'
...
const removerItem = function(nome){
    ...
    //Se o indexof encontrar o conteúdo ele devolve -1
...
//     // }
 ...
 removerItem('Alex') // Para encontrar o que quero preciso colocar um parametro
 console.log(listaDeNomes)
